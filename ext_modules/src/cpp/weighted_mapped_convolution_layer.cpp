#include "layers/weighted_mapped_convolution_layer.h"
#include "cpp/mapped_im2col.h"
...
torch::Tensor WeightedMappedConvForward(
    ...
    int64_t kernel_size, InterpolationType interpolation) {
...
torch::Tensor WeightedMappedConvBackwardWeight(
    torch::Tensor grad_output, torch::Tensor sample_map,
    torch::Tensor interp_weights, torch::Tensor input, int64_t kernel_size,

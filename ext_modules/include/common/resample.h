...
__host__ __device__ void ResampleToMap2D(
    ...
    const InterpolationType interpolation, T *data_out_ptr) {
  // Locations
  int64_t c = 0;
  int64_t x_in = 0;
  int64_t y_in = 0;
  IndToSubCHW(index, in_height, in_width, c, y_in, x_in);
...
__host__ __device__ void ResampleFromMap2D(
    ...
    const int64_t channels, const int64_t in_height, const int64_t in_width,
    const int64_t out_height, const int64_t out_width,
    const InterpolationType interpolation, T *data_in_ptr) {
  // Locations
  int64_t c = 0;
  int64_t x_in = 0;
  int64_t y_in = 0;
...
__host__ __device__ void ResampleFromUVMaps(
    ...
    const int64_t in_width, const InterpolationType interpolation,
    T *data_in_ptr) {
  // Locations
  int64_t c = 0;
  int64_t x_in = 0;
